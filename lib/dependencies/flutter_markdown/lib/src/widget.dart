...
class _MarkdownWidgetState extends State<MarkdownWidget>
  ...
  TextSpan formatText(MarkdownStyleSheet styleSheet, String code) {
    ...
    TextStyle? codeBlockTextStyle = styleSheet.code!.copyWith(background: Paint()); // Couldn't add null // NBT
    codeBlockTextStyle.background!.color = Colors.transparent; // NBT
    return TextSpan(style: codeBlockTextStyle, text: code); // NBT
  }
